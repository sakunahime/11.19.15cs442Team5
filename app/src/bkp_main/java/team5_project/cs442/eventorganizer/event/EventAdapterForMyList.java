 ...
 */
public class EventAdapterForMyList extends ArrayAdapter<Event> implements Serializable {

    private int resource;

    public EventAdapterForMyList(Context context,
                                 int resource,
                                 List<Event> events) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        TextView event_name_text = (TextView) event_view.findViewById(R.id.my_event_name_info);
        TextView event_time_text = (TextView) event_view.findViewById(R.id.my_event_start_time_info);
